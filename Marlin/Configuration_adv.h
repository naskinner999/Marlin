 ...
 */
#define INPUT_SHAPING_X //NS
#define INPUT_SHAPING_Y //NS
  ...
  #define SHAPING_MENU                //NS Add a menu to the LCD to set shaping parameters. 
#endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  10      //NS // (steps or mm) Steps or millimeter distance for each Z babystep
  ...
  #define BABYSTEP_ZPROBE_OFFSET          //NS //Combine M851 Z and Babystepping
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.4         //NS // (mm) Compression length applying to all extruders
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      30  //NS // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   30  //NS // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         30  //NS // (mm) Length to extrude after loading.
  ...
  #define PARK_HEAD_ON_PAUSE                    //NS // Park the nozzle during pause and filament change.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       600       //NS // (mA) RMS current. Multiply by 1.414 for peak current.
 ...
 */
#define HOST_ACTION_COMMANDS //NS
